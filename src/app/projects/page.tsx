          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border border-white/[0.08] bg-white/5 px-3 py-2 text-sm text-white placeholder-gray-600 focus:border-cyan-400 focus:outline-none"
                autoFocus
              />
            </div>
            <div>
            ...
            <div className="flex gap-3">
              <div className="flex-1">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={cn(
                      "w-full rounded-lg border bg-white/5 pl-9 pr-3 py-2 text-sm text-white placeholder-gray-600 focus:outline-none",
                      urlError ? "border-red-500 focus:border-red-500" : "border-white/[0.08] focus:border-cyan-400"
                    )}
                  />
                </div>
              ...
              <div className="relative" ref={dropdownRef}>
                <label className="mb-1 block text-sm text-gray-400">Agents</label>
                <button
                  type="button"
                ...
                {/* Dropdown panel */}
                {showAgentDropdown && (
                  <div className="absolute right-0 z-50 mt-1 w-[340px] rounded-lg border border-white/[0.06] bg-white/[0.02] shadow-xl">
                    {/* Select all / none controls */}
                    <div className="flex items-center justify-between border-b border-white/[0.04] px-3 py-2">
                      <span className="text-xs text-gray-400">{selectedAgents.size} selected</span>
                      ...
                      {visibleAgents.map((agent) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <span className={cn('text-xs', isSelected ? 'text-gray-200' : 'text-gray-400')}>
                              {agent.name}
                            </span>
                          </button>
                        );
            ...
            <div>
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className={cn(
                    ...
                    newType === 'internal'
                      ...
                      : 'border-white/[0.08] hover:border-cyan-500/20'
                  )}
                >
                  <Building2 className={cn('h-6 w-6', newType === 'internal' ? 'text-amber-400' : 'text-gray-500')} />
                  <span className={cn('text-sm font-medium', newType === 'internal' ? 'text-amber-400' : 'text-gray-400')}>
                    Internal
                  </span>
                ...
                >
                  ...
                  <span className={cn('text-sm font-medium', newType === 'external' ? 'text-cyan-400' : 'text-gray-400')}>
                    External
                  </span>
                  <span className="text-xs text-gray-500 text-center">
        ...
        >
          {projects.map((project) => (
            <motion.div
              ...
              className="group rounded-lg border border-white/[0.04] bg-[rgba(2,2,5,0.6)] p-5 transition-colors hover:border-cyan-500/15"
            >
              <div className="mb-3 flex items-start justify-between">
                ...
                <div className="flex gap-1">
                  <button
                    ...
                    className="rounded p-1 text-gray-600 opacity-0 transition-opacity hover:bg-white/5 hover:text-cyan-400 group-hover:opacity-100"
                    title="Edit project"
                  >
                  ...
                  <button
                    ...
                    className="rounded p-1 text-gray-600 opacity-0 transition-opacity hover:bg-white/5 hover:text-red-400 group-hover:opacity-100"
              ...
              <button
                ...
                className="flex w-full items-center justify-center gap-2 rounded-lg border border-white/[0.08] px-3 py-2 text-sm text-gray-300 transition-colors hover:bg-white/5 hover:text-white"
              >
                Launch Pipeline
      ...
      {editProject && (
        ...
        >
          <motion.div
            ...
            className="mx-4 w-full max-w-lg rounded-xl border border-white/[0.06] bg-white/[0.02] p-6 shadow-2xl"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="mb-4 flex items-center justify-between">
              <h3 className="text-lg font-semibold text-white">Edit Project</h3>
              <button onClick={() => setEditProject(null)} className="rounded p-1 text-gray-400 hover:bg-white/5 hover:text-white">
                <X className="h-5 w-5" />
              </button>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={cn(
                      "w-full rounded-lg border bg-white/5 pl-9 pr-3 py-2 text-sm text-white placeholder-gray-600 focus:outline-none",
                      editUrlError ? "border-red-500 focus:border-red-500" : "border-white/[0.08] focus:border-cyan-400"
                    )}
                  />
                </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-2 text-sm text-gray-300">
                  ...
                  <span className="text-xs text-gray-600 ml-2">(cannot be changed)</span>
                </div>
              </div>
        ...
        return (
          ...
          >
            <motion.div
              ...
              exit={{ opacity: 0, scale: 0.95, y: 10 }}
              transition={{ duration: 0.25, ease: [0.25, 0.4, 0.25, 1] }}
              className="mx-4 w-full max-w-md rounded-xl border border-white/[0.06] bg-white/[0.02] p-6 shadow-2xl">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 rounded-lg border border-white/[0.08] px-4 py-2.5 text-sm text-gray-300 hover:bg-white/5 transition-colors"
                >
                  Cancel
                </button>
                <button
