  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="p-3 sm:p-4 bg-blue-500/5 rounded-lg border border-blue-500/20">
        ...
        <p className="text-xs sm:text-sm text-muted-foreground leading-relaxed">{validationData.reasoning || data?.reasoning || ''}</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className={`p-2.5 sm:p-3 rounded-lg ${config.bg} border ${config.border}`}>
      <div className="flex items-start justify-between gap-2 mb-1.5 sm:mb-2">
        <p className="text-xs sm:text-sm font-medium leading-snug">{risk.factor}</p>
